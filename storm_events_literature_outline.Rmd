...
events_2019 %>%
  ...
  scale_x_discrete(position = "top", labels = c("A powerful coastal storm\n along New Jersey to\n the Northeast", "An atmospheric river\n and cold front near\n Mount Saint Helena", "Line of thunderstorms", "Multiple storms over\n Missouri Ozarks", "Squall line of thunderstorms\n in South Carolina", "An atmospheric river\n in the North Bay", "Frontal boundary over\n the mid-Atlantic creating\n a low pressure wave", "971mb bomb cyclone\n moving out of the\n Rockies", "Strong cold front and\n deep upper level trough\n in the Ozarks", "Moderate to strong\n atmospheric river in\n California", "Several severe storms\n along southern plains", "Heat wave in eastern\n New York")) +
