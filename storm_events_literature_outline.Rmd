...
Until 1994, damage estimates were recorded on a logarithmic scale [@downton2005reanalysis]. NOAA now records damage estimates in thousands of dollars.
...
The value of a dollar has changed over time. This can be addressed by normalizing any dollar measurements to a certain year to prevent bias. 
